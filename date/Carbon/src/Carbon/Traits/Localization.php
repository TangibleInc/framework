...
namespace Tangible\Carbon\Traits;

use Tangible\Carbon\CarbonInterface;
use Tangible\Carbon\Exceptions\InvalidTypeException;
use Tangible\Carbon\Exceptions\NotLocaleAwareException;
use Tangible\Carbon\Language;
use Tangible\Carbon\Translator;
use Tangible\Carbon\TranslatorStrongTypeInterface;
use Closure;
use Tangible\Symfony\Component\Translation\TranslatorBagInterface;
use Tangible\Symfony\Component\Translation\TranslatorInterface;
use Tangible\Symfony\Contracts\Translation\LocaleAwareInterface;
use Tangible\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;

if (interface_exists('Tangible\\Symfony\\Contracts\\Translation\\TranslatorInterface') &&
    !interface_exists('Tangible\\Symfony\\Component\\Translation\\TranslatorInterface')
) {
    class_alias(
        'Tangible\\Symfony\\Contracts\\Translation\\TranslatorInterface',
        'Tangible\\Symfony\\Component\\Translation\\TranslatorInterface'
    );
}
